...
import com.amr_medhat_r.runningapp.db.RunningDatabase
...
import com.amr_medhat_r.runningapp.other.Constants.RUNNING_DATABASE_NAME
import com.amr_medhat_r.runningapp.other.Constants.SHARED_PREFERENCES_NAME
...
object AppModule {
    ...
    @Singleton
    @Provides
    fun provideProvideFirstTimeToggle(sharedPrefs: SharedPreferences) =
